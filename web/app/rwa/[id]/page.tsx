  ...
  return (
    <div className="min-h-screen py-12 px-4 dotted-background">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <Button variant="outline" asChild className="mb-4 border-2 border-black">
            <Link href="/my-rwas">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0)] overflow-hidden">
              <div className="relative">
                <img src={mockRWA.image || "/placeholder.svg"} alt={mockRWA.name} className="w-full h-auto" />
                <div className="absolute top-4 right-4">
                  ...
                  >
                    {mockRWA.status === "available" ? "Available" : "In Lending Process"}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-100 p-3 rounded-lg border-2 border-gray-200">
                    ...
                    <div className="font-bold">${mockRWA.value.toLocaleString()}</div>
                  </div>

                  <div className="bg-gray-100 p-3 rounded-lg border-2 border-gray-200">
                    <span className="text-sm text-gray-500">Years of Usage</span>
                    <div className="font-bold">{mockRWA.yearsOfUsage} years</div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  {mockRWA.status === "available" ? (
                    <Button onClick={() => setShowLendModal(true)} className="flex-1 border-2 border-black">
                      Request Loan
                    </Button>
                  ) : (
                    <Button variant="outline" className="flex-1 border-2 border-black" disabled>
              ...
              <div className="p-6">
                ...
                {mockRWA.status === "available" ? (
                  <div className="flex items-center justify-center py-8 text-center">
                    <div>
                      <p className="text-gray-600 mb-4">No active loan requests for this asset.</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold">${mockRWA.loanDetails.requestedAmount.toLocaleString()}</span>
                    </div>

                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Interest Rate:</span>
                      <span className="font-bold">{mockRWA.loanDetails.interestRate}% APR</span>
                    </div>
                    ...
                    {mockRWA.loanDetails.lenderOffer && !mockRWA.loanDetails.offerAccepted && !isOfferAccepted && (
                      <div className="mt-6 p-4 bg-yellow-100 rounded-md border-2 border-yellow-300">
                        <div className="flex items-start">
                          <AlertCircle className="h-5 w-5 text-yellow-500 mr-2 flex-shrink-0 mt-0.5" />
                          <div>
                            <h3 className="font-bold text-yellow-800">Lender Offer</h3>
                            <p className="text-sm text-yellow-700 mb-3">
                              A lender has made an offer for your loan request.
                            </p>
                            <div className="flex justify-between items-center mb-4">
                              <span className="text-yellow-800">Offered Amount:</span>
                            ...
                            <div className="flex gap-2">
                              ...
                              >
                                {isAcceptingOffer ? "Processing..." : "Accept Offer"}
                              </Button>
                              <Button variant="outline" size="sm" className="w-full" disabled={isAcceptingOffer}>
                                Decline
                              </Button>
                            </div>
                          </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-700 mb-3">
                              You've accepted the lender's offer. The loan will be processed shortly.
                            </p>
                            <div className="flex justify-between items-center">
                ...
                <div className="relative pl-8">
                  ...
                  <div className="relative mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{new Date(mockRWA.createdAt).toLocaleDateString()}</p>
                    </div>
                  </div>
                    ...
                    <div className="relative mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {new Date(new Date(mockRWA.createdAt).getTime() + 86400000).toLocaleDateString()}
                        </p>
                      </div>
                    </div>
                  )}
      ...
      {showLendModal && <LendModal rwa={mockRWA} onClose={() => setShowLendModal(false)} />}
    </div>
  )
}
